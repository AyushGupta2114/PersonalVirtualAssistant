...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\games\ML projects\PersonalVirtualAssistant'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\games\ML projects\PersonalVirtualAssistant\Scripts\deactivate.nu'
